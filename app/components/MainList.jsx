...
export const MainList = ({ array, loading, handleListClick }) => {
    return array.length == 0 || loading == true
        ? (<div role="status" className="border-t-2 border-stone-300 my-4 p-1">
            <svg aria-hidden="true" className="my-10 mx-auto w-8 h-8 text-gray-200 animate-spin dark:text-gray-600 fill-yellow-500" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
